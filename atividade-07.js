...
// → Seu código aqui:
let user = Keyboard.questionInt('digite sua idade: ');
if (user >= 18){
    console.log('Adulto')
}else if (user <= 12){
    console.log('criança')
...
// → Seu código aqui:
let temperatura = Keyboard.questionFloat("Qual a temperatura atual? ");
...
const motorista = {
    nome: Keyboard.question("Qual o seu nome? "),
    idade: Keyboard.questionInt("Qual a sua idade? "),
    possuiHabilitacao: Keyboard.keyInYN("Voce possui habilitacao? "),
}
...
// → Seu código aqui:
const ehEstudante = Keyboard.keyInYN("Voce e estudante");
const ehIdoso = Keyboard.keyInYN("Voce e idoso (60+)");
...
let prova1 = Keyboard.questionInt('Nota da prova 1: ');
let prova2 = Keyboard.questionInt('Nota da prova 2: ');
...
const n1 = Keyboard.questionFloat("Digite o primeiro numero: ");
const n2 = Keyboard.questionFloat("Digite o segundo numero: ");

console.log("Escolha a operacao:1 – Soma | 2 – Subtracao | 3 – Multiplicacao | 4 – Divisao");
const escolha = Keyboard.questionInt("Opcao: ");
const calculo = {
    numeroA: n1,
    numeroB: n2,
    operacao: escolha,
