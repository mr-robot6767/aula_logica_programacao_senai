...
let saldo = Keyboard.questionInt('digite seu saldo: ');
let taxas = Keyboard.questionFloat('Taxa de juros mensal em % (ex: 1.5): ');
let meses = Keyboard.questionInt("quantidade de meses: ");
...
// → Seu código aqui:
let alunos = Keyboard.questionInt('quantos alunos seraão cadastrados: ');
const listaAlunos = [];
for (let i = 0; i < quantidadeAlunos; i++) {
console.log(`--- cadastro do Aluno ${i + 1} ---`);

let nome = Keyboard.question(`nome do aluno: `)
