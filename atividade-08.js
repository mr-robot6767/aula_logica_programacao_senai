...
let turno = Keyboard.questionInt("Escolha o seu turno: ");
switch(turno){
    case "Manhã":
        console.log("Bom dia! Turno da manhã");
        break;
    case "Tarde":
        console.log("Bom dia! Turno da tarde");
        break;
    case "Noite":
        console.log("Bom dia! Turno da noite");
        break;
    default:
...
// → Seu código aqui:
let estacao = Keyboard.question("qual sua estacao favorita? verao, outono, inverno ou primavera: ")
switch(estacao){
    case "verao":
