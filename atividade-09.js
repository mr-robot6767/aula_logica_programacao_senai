...
// let numero = Keyboard.questionInt("Digite a tabuada desejada: ");
// for (let i = 1; i <= 10; i++) {
...
// → Seu código aqui:
// let numeroInteiro = Keyboard.questionInt("Digite um numero inteiro: ");
//     let soma = 0
//     for (let i = 1; i <= numeroInteiro; i++) {
//         soma += i;
//     }  
//     console.log(`A soma de 1 até ${numeroInteiro} é ${soma} `)
console.log("_______________________________");
...
// → Seu código aqui:
// let numeroatedez = Keyboard.questionInt("Digite um numero de 1 a 10: ");
// let fatorial = 1;
// for (let i = 1; i <= numeroatedez; i++) {
//     fatorial *= i;
//     console.log(`${numeroatedez}! = ${fatorial}`);
// }
...
const media = soma / salarios.lenght
