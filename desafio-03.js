...
// → Seu código aqui:
let espectadorNome = Keyboard.question('digite seu nome: ');
let espectadorIdade = Keyboard.questionInt('digite sua idade: ');
let classificacao = Keyboard.questionInt('Classificacao do filme (0, 10, 12, 14, 16 ou 18): ');

const cinema = {
    nome: espectadorNome,
    idade: espectadorIdade,
    classificacao: classificacao
};
if (cinema.classificacao === 0 || cinema.idade >= cinema.classificacao ) {
    console.log(`${cinema.nome} pode assistir. Boa sessão!`);
} else {
    console.log(`${cinema.nome} não pode assistir. Classificacao: ${cinema.classificacao} anos.`);
}
